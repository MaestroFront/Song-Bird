const birdsData = [
  [
    ...
    },
    {
      ...
      description:
        "Для ласточек характерно негромкое щебетание. Песни ласточек не смолкают на протяжении всего лета. Исследователи различают у птиц до 6 щебечущих звуков: «вит», «ви-вит», «чивит», «чиривит» и т.п. Ласточки любят петь дуэтом. Верх синевато-чёрный с синим отливом, брюхо, испод крыла и надхвостье чисто-белые. Хвост без вилочки, но с небольшим вырезом. Ноги полностью покрыты белыми перьями и пухом. Самцы и самки внешне друг от друга не отличаются. Молодые птицы похожи на взрослых, но более тусклые серовато-чёрные сверху и буровато-белые снизу. Линька у молодых и взрослых один раз в год и довольно продолжительная — с августа по март.",
    ...
    },
    {
      ...
      description:
        "Кукушку назвали так из-за особенностей ее песен. Звонкое «ку-ку» не спутать ни с какой другой птицей. Кукушки не строят гнезда, их потомство выращивают другие виды пернатых, которым кукушки подбрасывают свои яйца. Большинство видов ведут одиночный образ жизни и редко встречаются группами. Исключением является род Ани, которые строят коллективные гнёзда[3]. Представители семейства обитают в лесу, но некоторые предпочитают более открытую местность. Последние имеют длинные и сильные лапки, которые позволяют развивать скорость более 30 км/ч.",
    ...
    },
    {
      ...
      species: "Parus major",
      description:
        "В щебетании синиц различают более 40 различных звуковых сочетаний. Поют они практически круглый год, немного затихая только зимой. Синицы настоящие санитары леса. Одна пара синиц в период гнездования оберегает от вредителей десятки деревьев. В сильные морозы, если в кормушке пусто, синицы цепляются за рамы, стучат по стеклу, требовательно чвикают, напоминая людям, что они голодны и замерзают. Какой бы ни был холод, они все время зимуют рядом и не улетают, как другие, в теплые края.",
      image:
